...
export function vaultMap(): string {
  return [
    ...
    "",
    "## Entities - data/entities/<kind>/<slug>.md",
    ...
    "orgs/, things/. Slug = lowercase name, non-alphanumerics as '-'.",
    "```",
    "---",
    "name: Sam Rivera",
    ...
    "```",
    "- A page appears when the user saves an entity, or automatically once it",
    "  comes up in 3+ separate conversations.",
    ...
    "  refresh|backfill` (id = kind/slug, e.g. person/sam-rivera).",
    "",
    ...
    "  memory, intents, apps, entities) to any MCP-capable client.",
