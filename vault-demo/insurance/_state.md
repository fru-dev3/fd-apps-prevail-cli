...
- [ ] Maya (3): 529, child tax credit, term-life beneficiary, preschool recital Sat _(also: wealth, tax, calendar)_
- [ ] Borderline LDL 138 + low vitamin D _(also: health, fitness)_
- [ ] Add a $1M umbrella policy (no gap coverage yet) _(also: wealth)_
