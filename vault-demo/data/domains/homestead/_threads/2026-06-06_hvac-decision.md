...
Replace it now, before July. Here's the reasoning:
...
What SEER rating should I ask for?

## claude · opus-4

For Austin, TX, I'd spec a **16 SEER2** (the newer SEER2 standard replaced SEER in 2023, the rating looks slightly lower but the testing is more rigorous; a 16 SEER2 ≈ 18.5 old SEER).
